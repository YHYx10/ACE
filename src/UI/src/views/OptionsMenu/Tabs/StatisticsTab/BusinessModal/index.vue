<template>
  <div class="modal">
    ...
    <div class="modal__side">
      ...
      <div class="main">
        <div class="main__item">
          ...
          <div class="subtitle">This amount is advertised by your account</div>
        </div>
        <div class="main__item">
          <div class="category">{{ loc('mmain:stats:biz:taxcount') }}</div>
          <div class="title">{{ property.business.taxCount + '/' + taxMax }}$</div>
          <div class="subtitle">You have to pay taxes so as not to lose business</div>
        </div>
        <div class="main__item">
    ...
    <div class="modal__main">
      ...
      <div class="products">
        <products-item v-for="(item, index) in property.business.products" :key="index" :item="item" :bizType="property.business.type"
          @onChange="(name, price) => changePrice(name, price, index)" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changePrice(name, price, index) {
      this.property.business.products[index].price = price
