  ...
  <div class="statistics-tab">
    <div class="statistics-tab__left">
      <div class="card_panel">
        <div class="card_flex">
          <div class="card_icon size_30 no_border">
            <img src="/img/optionsMenu/statisticsTab/icons/icon_name.svg" class="info-item__icon" />
          </div>
          <div class="card_labels card_gray_white">
            <h3>Name and last name</h3>
            <h4>{{ statistics.username }}</h4>
          </div>
        </div>
      </div>
      <div class="card_panel">
        <div class="card_2cols">
          <div class="card_flex">
            <div class="card_icon size_30">
              <img src="/img/optionsMenu/statisticsTab/icons/icon_level.svg" class="info-item__icon" />
            </div>
            <div class="card_labels card_gray_white">
              <h3>level</h3>
              <h4>{{ statistics.level }}</h4>
            </div>
          </div> 
          <div class="card_flex">
            <div class="card_icon size_30">
              <img src="/img/optionsMenu/statisticsTab/icons/icon_stat.svg" class="info-item__icon" />
            </div>
            <div class="card_labels card_gray_white">
              <h3>EXP</h3>
              <h4>{{ statistics.exp }}</h4>
            </div>
          </div>        
        </div>
      </div>
      <div class="card_panel card_container card_panel_info">
        <info-item
...
.card_panel:first-child {
  margin-top: 0;
}
.card_panel.card_container {
  margin: 0;
  padding: 0;
  background: none;
  border: none;
...
.card_icon.size_30 img {
  width: 2rem;
  height: 2rem;
  margin: 0.25rem 0 0 0;
}
.card_labels h4, .card_label h4 {
  color: white;
  text-transform: uppercase;
  font-size: 12.55px;
  font-weight: normal;
}
.card_labels.card_gray_white h3 {
  color: rgba(255, 255, 255, 0.55);
  font-size: 8.55px;
}
.card_labels.card_gray_white h4 {
  font-size: 10.73px;
}
.card_2cols {
  display: flex;
...
.card_2cols .card_flex {
  width: 30%;
  margin: 0;
  padding: 0;
}
.card_2cols .card_icon {
  margin: 0;
  border: none;
}
.statistics-tab {
