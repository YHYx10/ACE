  ...
  <div class="frac-memb">
    <div class="frac-memb-heading">
      <div class="frac-memb-amount">
        <div class="category">The number of players in the organization</div>
      ...
      <div class="frac-memb-invite">
        ...
        <div class="frac-memb-invite-text">
          ...
          <div class="title">new player</div>
        </div>
      </div>
      <div class="frac-memb-capt" v-show="fraction.id > 0 && fraction.id < 6" @click="openCaptTeam">
    ...
    <div class="frac-memb-list">
      <div class="frac-memb-list-item" v-for="(member, index) in sortedMembers" :key="index">
        ...
        <div class="frac-memb-list-setrank item__btn" @click="setRank(member.username, member.rank)">Rank</div>
        <div class="frac-memb-list-kick item__btn" @click="kick(member.username)">kick</div>
      </div>
    </div>
  </div>
</template>
