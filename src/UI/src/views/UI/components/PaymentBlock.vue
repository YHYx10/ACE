<template>
  <div class="payment-component">
    <div
      class="payment-type"
      :class="{
        'payment-short': layout === 'short',
        'payment-vertical': layout === 'vertical',
      }"
    >
      <div class="wrap">
        <button
    ...
    <div class="payment">
      ...
      <button class="payment-buy button-second" @click="onBuy">
        {{ loc('barber_12') }}
      </button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    onBuy() {
      this.$emit('onBuy', this.paymentType)
    },
    setPaymentType(value) {
      this.paymentType = value
      console.log(value)
      this.$emit('onChangePay', this.paymentType)
    },
  },
}
</script>
...
.payment-component {
  ...
  .payment {
    ...
    button {
      ...
      &.payment-buy {
        border: 0.16vh solid rgba(255, 255, 255, 0.22);
        font-family: 'Montserrat';
        &:hover {
...
.payment-component .payment-vertical {
  display: flex;
  .wrap {
    display: flex;
    flex-direction: column;
