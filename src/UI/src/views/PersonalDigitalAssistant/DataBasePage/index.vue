...
.prisoners-list__body {
  height: 25.3rem !important;
  padding-right: 0.55rem !important;
  margin-right: -0.55rem !important;
}

/* Premium MDT arrest database pass */
.data-base-page {
  .search-wrap {
    ...
    input {
      background: rgba(3, 12, 25, 0.6) !important;
      border-color: rgba(103, 190, 255, 0.14) !important;
      box-shadow: inset 0 0 1rem rgba(0, 0, 0, 0.18) !important;
    }
...
/* Asset-backed MDT database styling */
.data-base-page {
  .search-wrap {
    ...
    &::before {
      ...
      width: 0.9rem;
      height: 0.9rem;
      background: url("/img/mdt/search.svg") center / contain no-repeat;
      filter: drop-shadow(0 0 0.45rem rgba(80, 190, 255, 0.48));
      z-index: 2;
    }
  ...
  .prisoners-list {
    ...
    border: 1px solid rgba(96, 194, 255, 0.14) !important;
    background: rgba(1, 10, 23, 0.42) !important;
    box-shadow: inset 0 0 1.3rem rgba(31, 139, 255, 0.055) !important;
  }
}
</style>