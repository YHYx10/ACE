  ...
  <div class="categories-tab">
    <div class="categories-tab__list">
      <categories-block
        ...
        @change-open="(status) => changeOpen(index, status)"
      />
    </div>
...
export default {
  ...
  methods: {
    changeOpen(idx, status) {
      console.log(this.$refs[`categories${this.open}`])
      ...
      if (this.open === null) {
        ...
        this.$refs[`categories${this.open}`][0].hide();
        this.open = idx;
        return;
      }
    },
