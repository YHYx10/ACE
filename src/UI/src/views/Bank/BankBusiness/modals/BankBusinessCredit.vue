<template>
  <div class="bank-business-credit bank-modal">
    <div class="bank-business-credit__wrap bank-modal__wrap">
      ...
      ></div>
      <div class="bank-modal-title"> Credit against the deposit</div>
      <div class="bank-modal-desc bank-business-credit-desc">The loan spends a 50% business price that is not used to the state</div>
      <div class="bank-modal-desc bank-business-credit-desc">If you do not repay the loan in time, the bank will take on a business for itself</div>
      <div class="bank-business-credit__info">
        <div class="bank-modal-desc">Approved quantity</div>
      ...
      <div class="bank-business-credit__prompt">
        <div class="bank-business-credit__prompt-desc"> Credit is issued at{{approvedRate}}%</div>
        <div class="bank-business-credit__prompt-value">The amount of debt will be: <span>$ {{finishSumm.toLocaleString('ru')}}</span></div>
      </div>
      <div 
