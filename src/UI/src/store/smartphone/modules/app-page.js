export default {
  ...
  state: {
    applications: [
      ...
      { id: 4, title: 'phone:app:tit:5', icon: 'bankGo', key: 'BankTab', section: 'GeneralSection', isAvailable: true, isInstalled: true, desc: 'phone:app:desc:5', img: 'bank', tagline: 'phone:app:tag:5', forMoney: false },
      ...
      { id: 10, title: 'Finder', icon: 'finder', key: 'FinderTab', section: 'WelcomeSection', isAvailable: true, isInstalled: true, desc: 'Dating app for city connections', img: 'finder', tagline: 'Find your next<br>RP connection', forMoney: false },
    ],
    mainApplications: [
      { id: 0, key: 'ContactsTab', icon: 'contacts', section: 'GeneralSection', isAvailable: true, forMoney: false },
      { id: 1, key: 'MessengerTab', icon: 'message', section: 'GeneralSection', isAvailable: true, forMoney: false },
      // { id: 1, key: 'MsgTab', icon: 'message', section: 'GeneralSection', isAvailable: true, forMoney: false },
      // { id: 2, key: 'MapTab', icon: 'map', section: 'GeneralSection', isAvailable: true, forMoney: false },
      
      { id: 9, title: 'phone:app:tit:9', icon: 'camera', type: 'triggerEvent', eventName: 'phone::camera::open', isAvailable: true, isInstalled: true, desc: 'phone:app:desc:9', img: 'camera', tagline: 'phone:app:tag:9', forMoney: false },
