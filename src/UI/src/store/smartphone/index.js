...
import finderPage from './modules/finder-page';
...
export default {
  ...
  state: {
    ...
    gpsData: {
      ...
      _cachedItems: {
        "atms": [
          { Title: 'ATM', Icon: 'atm', Address: '3517 W. Gray St. Utica, Pennsylvania 57867', Position: { X: 0, Y: 0, Z: 0 } }
        ]
      },
      categoryItems: [
        { title: 'Arms stores №12', icon: 'fuel', address: '3517 W. Gray St. Utica, Pennsylvania 57867', distance: 12000 },
        { title: 'Weapons stores №12', icon: 'fuel', address: '3517 W. Gray St. Utica, Pennsylvania 57867', distance: 12000 },
      ]
    }
  },
