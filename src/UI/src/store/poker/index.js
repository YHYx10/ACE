export default {
  ...
  state: {
    ...
    otherPlayers: [
      { id: 1, show: true, avatar: '/img/poker/avatar.png', name: 'FirstuseruseruserFirstuseruseruser user', currentRate: 374823, chipsCount: 3000000000, bank: 4200, state: 'Equalized(а)', cards: ['back', 'SS14'], winCombinations: [], isWinner: false, cardsDisabled: false, isVoise: false},
      { id: 2, show: true, avatar: '/img/poker/avatar.png', name: 'SecondSecondFirstuseruseruser user', currentRate: 999, chipsCount: 40000000, bank: 4200, state: 'Thinking', cards: ['back', 'SS14'], winCombinations: [], isWinner: false, cardsDisabled: false, isVoise: false},
      { id: 3, show: true, avatar: '/img/poker/avatar.png', name: 'Thrid useruseruser', currentRate: 100, chipsCount: 5000000000, bank: 4200, state: 'Equalized(а)', cards: ['back', 'SS14'], winCombinations: [], isWinner: false, cardsDisabled: false, isVoise: false},
      { id: 4, show: true, avatar: 'https://img.redbull.com/images/c_crop,x_0,y_0,h_1822,w_3239/c_fill,w_890,h_593/q_auto,f_auto/redbullcom/2017/03/24/1331850781287_2/how-long-will-it-take-you-to-get-these-cars', name: 'Fourth useruseruser', currentRate: 50, chipsCount: 60000, bank: 4200, state: 'Equalized(а)', cards: ['back', 'SS14'], winCombinations: [], isWinner: false, cardsDisabled: false, isVoise: false},
      { id: 5, show: true, avatar: '/img/poker/avatar.png', name: 'Fifth useruseruser', currentRate: 100, chipsCount: 7000000000, bank: 4200, state: 'Equalized(а)', cards: ['DD10', 'SS14'], winCombinations: [], isWinner: false, cardsDisabled: false, isVoise: false}
    ],
    activePlayer: 0,
    currentPlayer: { id: 0, avatar: 'https://image.api.playstation.com/vulcan/img/rnd/202102/0422/TkQfZ0v0NF1p8YHovQPIYtr5.png', name: 'Current user', currentRate: 1, bank: 4200, chipsCount: 99990, state: 'Equalized(а)', cards: ['SS14', 'SS12'], winCombinations: [], isWinner: true, cardsDisabled: false, isVoise: true },
