...
export default {
    ...
    state: {
        ...
        promptData: {
            ...
            items: [
                ...
                { key: 'I', text: 'To open the infoPopandel' },
            ]
        },
        reportsCount: null,
        // CHIPS
        ...
        untilCaptureTimerEnabled: false,
        untilCaptureTimerMessage: '',
        notificationText: 'You successfully surrendered to rights successfully surrendered to the rights you successfully surrendered',
        ...
        tip: {
            show: false,
            text: 'An example of a message to the player'
        },
        phaseTimer: {
            show: false,
            title: 'Phase 2',
    ...
    mutations: {
        ...
        setArrestTimer(state, { time, reason }) 
		{
            ...
            state.artimer = {
                expiried: new Date(nowTime.getTime() + time),
                reason
            };
        },
        resetKillog(state) {
        ...
        //setBonusTime: function(state, {timeout, moneyBonus}) {
          //  if (state.bonusDonateMoney.timer) {
            //    clearInterval(state.bonusDonateMoney.timer)
          ///      state.bonusDonateMoney.timer = null
           // }
///
        //    state.bonusDonateMoney = {
       ///         active: timeout > 0,
                //timeout: timeout,
     ...
     ///       }
        ...
        ///    state.bonusDonateMoney.timer = setInterval(() => {
         //       if (state.bonusDonateMoney.timeout <= 0) {
           ////         clearInterval(state.bonusDonateMoney.timer)
            ////        state.bonusDonateMoney.active = false;
             ///       return;
              ///  }

               /// state.bonusDonateMoney.timeout -= 1;
                ///state.bonusDonateMoney.moneyBonus = 2222;
            ///}, 60 * 1000)
        ///},
        ...
        setReportsCount: function (state, value) {
            state.reportsCount = Number(value || 0)
        },
