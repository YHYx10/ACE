  ...
  state: {
    ...
    productsSell: [
      ...
      },
      {
        name: 'gui_720',
        cost: 20000,
        image: 'LowFishingCage',
        product: 'LowFishingCage',
        single: true,
      },
      {
        name: 'gui_721',
        cost: 20000,
        image: 'MiddleFishingCage',
        product: 'MiddleFishingCage',
        single: true,
      },
      {
        name: 'gui_722',
        cost: 20000,
        image: 'HightFishingCage',
        product: 'HightFishingCage',
        single: true,
      },
      {
        name: 'gui_723',
  ...
  mutations: {
    putInBasket: function(state, { name, cost, image, product }) {
      ...
      if (newItemIndex === null) {
        basket.push({ unicName: name, cost, image, product, count: 1 })
      } else {
