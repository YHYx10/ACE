      ...
      partiesList: [
        {
          ...
          vote: false,
          name: 'Party',
          desc: 'Do you already have the first level and drivers license of class B?Forward!Direct orders at different points receive money for this.Just dont forget to pump up.Strength and endurance are needed to carry heavy loads.',
          countVote: 17
        },
        {
          id: 1,
        ...
        },
        {
          ...
          vote: false,
          name: 'Party 3',
          desc: 'Do you already have the first level and drivers license of class B?Forward!Draw orders at different points receive money for this.',
          countVote: 13
        },
        {
          id: 4,
        ...
        },
        {
          ...
          vote: false,
          name: 'Party 7',
          desc: 'Do you have class B rights?Forward!Direct orders at different points receive money for this.Just dont forget to pump up.Strength and endurance are needed to carry heavy loads.',
          countVote: 8
        },
      ]
    },
