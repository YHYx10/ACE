    ...
    internal class Family : IBankAccount, IOrganization
    {
        ...
        private void UpdateClothesPoint()
        {
            ...
            _clothesShape = InteractShape.Create(ClothesPoint, 1, 2, ClothesDimension)
                .AddInteraction(SkinManager.OpenFamilySkinMenu, "Kleidung wechseln ")
        ...
        {
            if (PaymentHystory == null) PaymentHystory = BankManager.GetMemberPayments(Members.Values, this, "Prize (family)", 30);
